...
![Diagram 2a: Elimination Method — Setup & ACROSS Analysis](visuals/diagrams/chapter2/diagram_2.png)
...
![Diagram 2b: Elimination Method — DOWN Analysis & Solution](visuals/diagrams/chapter2/diagram_3.png)
...
![Diagram 3: The Cascade Effect](visuals/diagrams/chapter2/diagram_4.png)
...
![Diagram 4: Identifying Good Starting Points](visuals/diagrams/chapter2/diagram_5.png)
...
![Diagram 5a: Complex Intersection Analysis — Setting Up](visuals/diagrams/chapter2/diagram_6.png)
*Part 1: Write pencil marks based on each run's constraints.*

![Diagram 5b: Complex Intersection Analysis — The Solution](visuals/diagrams/chapter2/diagram_7.png)
*Part 2: Cross-check all constraints together to find the unique solution.*
...
![Diagram 6a: Troubleshooting — Repeated Digits](visuals/diagrams/chapter2/diagram_8.png)
*Part 1: The most common error — same digit used twice in a run.*

![Diagram 6b: Troubleshooting — Wrong Sums](visuals/diagrams/chapter2/diagram_9.png)
*Part 2: Finding errors when sums don't add up correctly.*
