...
*White cells, gray cells, diagonal lines—and how to read across clues (upper-right) vs. down clues (lower-left).*
...
**Gray cells:** The walls and clue holders. They tell you what to do.

Think crossword. White cells = answers. Gray cells = structure.
...
Look at any gray clue cell. See the diagonal line?
...
Example:
- Gray cell shows "17" in upper-right
...
Ends when it hits another gray cell or the grid edge.
...
Runs start at clues. End at gray cells or edges. Simple.
...
Gray cells with two clues are tricky when you're moving fast.
